...
meta_23$cod_end_fullness <- paste0("\"",meta_23$cod_end_fullness, "\"" )
...
meta_24$cod_end_fullness <- str_replace_all(meta_24$cod_end_fullness, pattern = "\"", replacement = "")

meta_24$cod_end_fullness <- paste0("\"",meta_24$cod_end_fullness, "\"" )
